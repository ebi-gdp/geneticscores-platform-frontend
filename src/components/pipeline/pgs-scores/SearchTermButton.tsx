...
interface SearchTermButtonType {
    searchFunction: (args: string) => void,
    searchTerm: string
}

export const SearchTermButton = ({searchFunction, searchTerm}: SearchTermButtonType) => {
    return (
        <button type="button"
            ...
            <svg className="vf-icon vf-icon--search-btn | vf-button__icon" aria-hidden="true"
                 xmlns="http://www.w3.org/2000/svg"
                 version="1.1" viewBox="0 0 140 140" width="140" height="140">
